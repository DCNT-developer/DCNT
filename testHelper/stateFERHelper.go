...
//111111118d918a8be684e0dac725493a75862ef96d2d3f43f84b26969329bf03 = echo -n "This chain contains messages which coordinate the FCT to EC conversion rate amongst dcnt nodes." | factom-cli addchain -e "FCT EC Conversion Rate Chain" -e "1950454129" EC2DKSYyRcNWf7RS963VFYgMExoHRYLHVeCfQ9PGPmNzwrcmgm2r
...
import (
	...
	ed "github.com/DCNT-developer/ed25519"
	"github.com/DCNT-developer/factom"
	"github.com/DCNT-developer/dcnt/common/directoryBlock"
	"github.com/DCNT-developer/dcnt/common/entryBlock"
	"github.com/DCNT-developer/dcnt/common/entryBlock/specialEntries"
