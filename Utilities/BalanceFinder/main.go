...
import (
	...
	"github.com/DCNT-developer/dcnt/Utilities/tools"
...
func main() {
	...
	fmt.Println("All balance hashes cannot be compared to those presented in dcnt. Only compared to others made by the tool.")
