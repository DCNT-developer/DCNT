...
func PrintState(state *State) {
	...
	str = fmt.Sprintf("%s %35s = %+v\n", str, "dcntVersion", state.dcntVersion)
	...
	str = fmt.Sprintf("%s %35s = %+v\n", str, "dcntTLSEnable", state.dcntTLSEnable)
	str = fmt.Sprintf("%s %35s = %+v\n", str, "dcntTLSKeyFile", state.dcntTLSKeyFile)
	str = fmt.Sprintf("%s %35s = %+v\n", str, "dcntTLSCertFile", state.dcntTLSCertFile)
	str = fmt.Sprintf("%s %35s = %+v\n", str, "dcntLocations", state.dcntLocations)
